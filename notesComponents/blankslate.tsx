    ...
    <>
      {show && (
        ...
        >
          ...
          <Box color="fg.default" fontSize={2} width="75%" maxWidth={500} m={3}>
            Start a new project by creating or selecting a GitHub repo from the
            Settings tab, or log in and continue working on your last project.
          </Box>
          <Box m={2}>
